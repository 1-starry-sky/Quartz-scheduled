...
public class JobDto implements Serializable {
    ...
    public String toString() {
        return "JobDto [jobName=" + jobName + ", jobGroupName=" + jobGroupName + ", triggerName=" + triggerName
                + ", triggerGroupName=" + triggerGroupName + ", cronExpression=" + cronExpression
                + ", previousFireTime=" + previousFireTime + ", nextFireTime=" + nextFireTime + ", jobStatus="
                + jobStatus + ", startTime=" + startTime + ", endTime=" + endTime + ", jobClass=" + jobClass
                + ", count=" + count + ", jobDataMap=" + jobDataMap + ", oldJobName=" + oldJobName
                + ", oldJobGroupName=" + oldJobGroupName + ", oldTriggerName=" + oldTriggerName
